...
insta_username = data['dung_nq']
insta_password = data['anhdung5']
friendlist = data['xuxu_maru','ha_duyenn','kaori_chan_2312']
hashtags = data['hanoi','instagood','yeu']
...
comments = ['Đẹp! @{}',
    'Thích ghê! @{}',
    'Insta toàn ảnh đẹp vậy :thumbsup:',
    'Được đấy :open_mouth:',
    'Chụp bằng cam gì mà đẹp thế @{}?',
    'Thích cái ảnh này vãi @{}',
    'Tuyệt vời @{}',
    'Cuốn vãi @{}',
    ':raised_hands: Yes!',
    'Đẹp vãi @{} :muscle:']
